        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-gray-900">{{ $category->nombre }}</p>
                </div>
            </div>

            <div class="flex items-center space-x-4 pt-6">
                @can('editar categoria')
                    <a href="{{ route('categories.edit', $category) }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                        Editar Categoría
                    </a>
                @endcan
            </div>
